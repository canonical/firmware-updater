...
extension FwupdExceptionL10n on FwupdException {
  String localize(BuildContext context) {
    ...
    return switch (runtimeType) {
      FwupdInternalException => l10n.fwupdErrorInternal,
      FwupdVersionNewerException => l10n.fwupdErrorVersionNewer,
      FwupdVersionSameException => l10n.fwupdErrorVersionSame,
      FwupdAlreadyPendingException => l10n.fwupdErrorAlreadyPending,
      FwupdAuthFailedException => l10n.fwupdErrorAuthFailed,
      FwupdReadException => l10n.fwupdErrorRead,
      FwupdWriteException => l10n.fwupdErrorWrite,
      FwupdInvalidFileException => l10n.fwupdErrorInvalidFile,
      FwupdNotFoundException => l10n.fwupdErrorNotFound,
      FwupdNothingToDoException => l10n.fwupdErrorNothingToDo,
      FwupdNotSupportedException => l10n.fwupdErrorNotSupported,
      FwupdSignatureInvalidException => l10n.fwupdErrorSignatureInvalid,
      FwupdAcPowerRequiredException => l10n.fwupdErrorAcPowerRequired,
      FwupdPermissionDeniedException => l10n.fwupdErrorPermissionDenied,
      FwupdBrokenSystemException => l10n.fwupdErrorBrokenSystem,
      FwupdBatteryLevelTooLowException => l10n.fwupdErrorBatteryLevelTooLow,
      FwupdNeedsUserActionException => l10n.fwupdErrorNeedsUserAction,
      //  FwupdAuthExpiredException => l10n.fwupdErrorAuthExpired,
