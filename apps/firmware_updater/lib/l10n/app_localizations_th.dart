...
class AppLocalizationsTh extends AppLocalizations {
  ...
  @override
  String get appTitle => 'เครื่องมือปรับรุ่นเฟิร์มแวร์';

  @override
  String get batteryWarning => 'คำเตือน: การปรับรุ่นอุปกรณ์บางรายการอาจติดตั้งได้ก็ต่อเมื่อใช้พลังงานจากแหล่งอื่นเท่านั้น!';

  @override
  String get checksum => 'ผลรวมตรวจสอบ';
  ...
  @override
  String get deviceUnavailable => 'อุปกรณ์จะไม่สามารถใช้การได้ระหว่างการกระทำนี้';

  @override
  String get deviceRequest => 'คำขอจากอุปกรณ์';
  ...
  String downgradeConfirm(String name, String version) {
    return 'ต้องการดาวน์เกรด <b>$name</b> เป็นรุ่น <b>$version</b> หรือไม่?';
  }

  @override
  String get flags => 'แฟล็ก';

  @override
  String get fwupdDeviceFlagInternal => 'อุปกรณ์ภายใน';

  @override
  String get fwupdDeviceFlagUpdatable => 'ปรับรุ่นได้';

  @override
  String get fwupdDeviceFlagOnlyOffline => 'การปรับรุ่นต้องการให้เริ่มระบบใหม่';
