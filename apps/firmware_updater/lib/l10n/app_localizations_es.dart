...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get affectsFdeWarningTitle =>
      'Puede perder todos sus datos sin claves de recuperación';

  @override
  String get affectsFdeWarningBody1 =>
      'Asegúrese que tenga claves de recuperación para todas sus unidades cifradas. Necesitar introducirlas al arrancar tras actualizar el firmware.';

  @override
  String get affectsFdeWarningBody2 =>
      'Necesita las claves de recuperación porque ha habilitado el cifrado del hardware respaldado en Ubuntu u otro sistema operativo en este equipo.';
  ...
  String get batteryWarning =>
      'Advertencia: ¡es posible que algunas actualizaciones del dispositivo solo estén disponibles con alimentación externa!';
  ...
  String get deviceUnavailable =>
      'El dispositivo no estará disponible durante esta operación.';
  ...
  String get fwupdDeviceFlagRequireAc =>
      'El sistema requiere una fuente de alimentación externa';
  ...
  String get fwupdDeviceFlagNeedsBootloader =>
      'Requiere un cargador de arranque';
  ...
  String get fwupdDeviceFlagNeedsReboot =>
      'Necesita un reinicio despues de la instalación';

  @override
  String get fwupdDeviceFlagNeedsShutdown =>
      'Necesita apagar tras la instalación';
  ...
  String get fwupdDeviceFlagInstallParentFirst =>
      'Instalar en el dispositivo principal primero';
  ...
  String get fwupdDeviceFlagWaitForReplug =>
      'El hardware espera a ser reconectado';

  @override
  String get fwupdDeviceFlagIgnoreValidation =>
      'Descartar validación de comprobaciones de seguridad';
  ...
  String get fwupdDeviceFlagNeedsActivation =>
      'Acutalización de dispositivo necesita activación';

  @override
  String get fwupdDeviceFlagWillDisappear =>
      'El dispositivo no reaparecerá tras finalizar la actualización';

  @override
  String get fwupdDeviceFlagCanVerify =>
      'La verificación de suma criptográfica está disponible';

  @override
  String get fwupdDeviceFlagDualImage =>
      'El dispositivo almacena provisionalmente las actualizaciones';

  @override
  String get fwupdDeviceFlagSelfRecovery =>
      'El dispositivo se puede recuperar de fallas en la instalación';

  @override
  String get fwupdDeviceFlagUsableDuringUpdate =>
      'El dispositivo se puede usar durante la actualización';

  @override
  String get fwupdDeviceFlagVersionCheckRequired =>
      'Es necesario verificar la versión del firmware del dispositivo';

  @override
  String get fwupdDeviceFlagInstallAllReleases =>
      'Se requiere el dispositivo para instalar todas las versiones proporcionadas';

  @override
  String get fwupdDeviceFlagHasMultipleBranches =>
      'El dispositivo soporta el cambio a una versión diferente de firmware';

  @override
  String get fwupdDeviceFlagBackupBeforeInstall =>
      'El dispositivo respaldará el firmware antes de la instalación';

  @override
  String get fwupdDeviceFlagWildcardInstall =>
      'Todos los dispositivos del mismo tipo se actualizarán a la vez';

  @override
  String get fwupdDeviceFlagOnlyVersionUpgrade =>
      'Solo se permiten las actualizaciones de versión';
  ...
  String get fwupdDeviceFlagAffectsFde =>
      'Las claves de cifrado completo de disco podrían invalidarse al actualizar';
  ...
  String get fwupdErrorVersionNewer =>
      'Se instaló una versión más reciente del firmware';

  @override
  String get fwupdErrorVersionSame =>
      'Se instaló la misma versión del firmware';

  @override
  String get fwupdErrorAlreadyPending =>
      'Ya se configuró la instalación sin conexión';
  ...
  String get fwupdErrorBrokenSystem =>
      'Se configuró el sistema de manera errónea';

  @override
  String get fwupdErrorBatteryLevelTooLow =>
      'El nivel de la batería del sistema es demasiado bajo';

  @override
  String get fwupdErrorNeedsUserAction =>
      'Necesita efectuar una acción para completar la actualización';

  @override
  String get fwupdErrorAuthExpired =>
      'No se pudo autenticar porque los datos de acceso caducaron';
  ...
  String get fwupdStatusScheduling =>
      'Programando una actualización sin conexión';
  ...
  String get rebootConfirmMessage =>
      'Debe reiniciar el dispositivo para completar la actualización. Asegúrese de que el dispositivo esté enchufado o cargado por completo. Guarde sus archivos antes de reiniciar para evitar perder datos.';
  ...
  String get updateChecksumsInfo =>
      'Esto grabará las sumas criptográficas actuales como verificadas.';
